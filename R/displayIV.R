#' @title        displayIV
#'
#' @description  This function displays the Information Values  of the levels of an attribute.
#'
...
displayIV<-function(dset,col="xyz",resp="y",adjFactor=0.5,bins=10)
{
  ...
  iv<-(df$non_response_pct-df$response_pct)*woe
